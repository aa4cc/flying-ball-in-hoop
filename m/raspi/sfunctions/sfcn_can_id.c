 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Mon May 15 09:53:49 2017
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sfcn_can_id
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sfcn_can_id_Outputs_wrapper(const real32_T *in,
...
extern void sfcn_can_id_Update_wrapper(const real32_T *in,
			const uint32_T *tx_id,
			real32_T *pos,
			real32_T *vel,
			real32_T *iq,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    sfcn_can_id_Outputs_wrapper(in, tx_id, pos, vel, iq, rx_id, xD, Ts, p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sfcn_can_id_Update_wrapper(in, tx_id, pos, vel, iq, rx_id,  xD, Ts, p_width0);
}
