 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Fri Apr 21 10:31:13 2017
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sfcn_can_txrxID
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sfcn_can_txrxID_Outputs_wrapper(const real32_T *in,
...
extern void sfcn_can_txrxID_Update_wrapper(const real32_T *in,
			const uint32_T *tx_id,
			real32_T *pos,
			real32_T *vel,
			real32_T *iq,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const uint32_T   *tx_id  = (const uint32_T*) ssGetInputPortSignal(S,1);
    ...
    uint32_T        *rx_id  = (uint32_T *)ssGetOutputPortRealSignal(S,3);
    const real_T   *xD = ssGetDiscStates(S);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const real_T  *Ts  = (const real_T *)mxGetData(PARAM_DEF0(S));

    sfcn_can_txrxID_Outputs_wrapper(in, tx_id, pos, vel, iq, rx_id, xD, Ts, p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sfcn_can_txrxID_Update_wrapper(in, tx_id, pos, vel, iq, rx_id,  xD, Ts, p_width0);
}
