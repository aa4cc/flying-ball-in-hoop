...
disp('Mark the outer screw positions in clock-wise direction on the hoop; as the last (7th) point, mark the center of the hoop')
[x_screw_marked, y_screw_marked] = ginput(7);
